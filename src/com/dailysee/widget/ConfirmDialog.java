...
public class ConfirmDialog extends BaseDialog {
	...
	public ConfirmDialog(Context context, String confirmMsg, boolean cancelEnable, String cancelText, int cancelTextColor, String okText, int okTextColor,
			View.OnClickListener onOKListener, View.OnClickListener cancelListener) {
		super(context);
		init(confirmMsg, cancelEnable, cancelText, cancelTextColor, okText, okTextColor, onOKListener, cancelListener);
	}
	...
	public ConfirmDialog(Context context, String confirmMsg, boolean cancelEnable, String cancelText, String okText, View.OnClickListener onOKListener,
		...
		this(context, confirmMsg, cancelEnable, cancelText, 0, okText, 0, onOKListener, cancelListener);
	}
	...
	protected void init(String confirmMsg, boolean cancelEnable, String cancelText, int cancelTextColor, String okText, int okTextColor, View.OnClickListener onOKListener,
