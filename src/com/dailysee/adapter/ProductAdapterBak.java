...
public class ProductAdapterBak extends BaseExpandableListAdapter {
	...
	public ProductAdapterBak(Context context, ArrayList<String> mGroupList, ArrayList<ArrayList<Product>> mChildrenList, Handler mHandler) {
