...
import com.dailysee.adapter.ProductAdapterBak;
...
public class MerchantProductListActivityBak extends BaseActivity implements OnClickListener, OnChildClickListener, OnLastItemVisibleListener {

	protected static final String TAG = MerchantProductListActivityBak.class.getSimpleName();
	...
	private ProductAdapterBak mAdapter;
...
//	private TextView mTvShoppingCount;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_merchant_product_list_bak);
...
//		mTvShoppingCount = (TextView) findViewById(R.id.tv_shopping_count);
	...
	public void onInitViewData() {
		...
		mAdapter = new ProductAdapterBak(getActivity(), mGroupList, mChildrenList, mHandler);
